    ...
    <?php include("nav.php"); ?>
        ...
        <div class="main-panel">
          ...
          <div class="row" style="margin-bottom:15px">
              <div class="col-md-6 offset-3">  <h3>CONSUMER DETAILS</h3> </div>
          </div>    
          <div class="row">
               ...
               <?php 
                  ...
                  while($rw=mysqli_fetch_array($tb))
                  {
                    echo("<tr>");
                      ...
                      echo("<td><button class='btn btn-primary' type='submit' name='btnconnection' value='".$rw['consumerid']."'>Connection</button>  </td>");
